define(function(require, exports, module) {
    ...
    (function() {
        ...
        function Ia(a, b, c, d) {
            ...
            return e + (g ? a.substr(0, g) + d : "") + a.substr(g).replace(/(\d{3})(?=\d)/g, "$1" + d) + (b ? c + L(f - a).toFixed(b).slice(2) : "")
        }
        ...
        function Ob(a, b, c, d) {
            ...
            d = 1;
            h = i[Xa]();
            for (var k = i.getTime(), l = i[Wa](), m = i[La](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; k < c;)
            e.push(k), b === B[ta] ? k = Ya(h + d * j, 0) : b === B[Ka] ? k = Ya(h, l + d * j) : !g && (b === B[oa] || b === B[Va]) ? k = Ya(h, l, m + d * j * (b === B[oa] ? 1 : 7)) : (k += b * j, b <= B[Ja] && k % B[oa] === i && (f[k] = oa)), d++;
            e.push(k);
            e.info = r(a, {
                higherRanks: f,
                totalRange: b * j
        ...
        var x, C = document,
            ...
            Ra, fa = C.documentElement.ontouchstart !== x,
            Jb = {},
            ub = 0,
            Za, M, cb, Oa, vb, B, ya = function() {},
            ia = "div",
            R = "none",
            wb = "rgba(192,192,192," + (Z ? 1.0E-6 : 0.0020) + ")",
            zb = "millisecond",
            ib = "second",
            Ua = "minute",
            Ja = "hour",
            ...
            Ka = "month",
            ta = "year",
            Ya, jb, kb, mb, La, Wa, Xa, Ab, Bb, lb, Cb, Db, $ = {};
        K.Highcharts = {};
        cb = function(a, b, c) {
        ...
        B = ka(zb, 1, ib, 1E3, Ua, 6E4, Ja, 36E5, oa, 864E5, Va, 6048E5, Ka, 2592E6, ta, 31556952E3);
        vb = {
            init: function(a, b, c) {
                var b = b || "",
                    d = a.shift,
        ...
        va.prototype = {
            ...
            attr: function(a, b) {
                ...
                if (la(a)) c = a, h === "circle" ? c = {
                    x: "cx",
                    y: "cy"
                }[c] || c : c === "strokeWidth" && (c = "stroke-width"), u = z(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (u = parseFloat(u));
                else for (c in a)
                if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                    ...
                    else if (c === "title") e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(pa, "title"), g.appendChild(e)), e.textContent = d;
                    ...
                    if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c)) for (e = l.length; e--;)
                    z(l[e], c, c === "height" ? y(d - (l[e].cutHeight || 0), 0) : d);
                    if ((c === "width" || c === "height") && h === "rect" && d < 0) d = 0;
                    this[c] = d;
                    p && this.updateTransform();
                    c === "text" ? (d !== this.textStr && delete this.bBox, this.textStr = d, this.added && i.buildText(this)) : j || z(g, c, d)
                }
                return u
            },
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if (b.tagName === "SPAN") {
                        ...
                        k = {};
                        if (aa !== this.cTT) {
                            if (t(j)) a.isSVG ? (q = Ca ? "-ms-transform" : tb ? "-webkit-transform" : bb ? "MozTransform" : Ib ? "-o-transform" : "", k[q] = k.transform = "rotate(" + j + "deg)") : (p = j * ab, u = V(p), p = Y(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", u, ", M12=", -p, ", M21=", p, ", M22=", u, ", sizingMethod='auto expand')"].join("") : R), H(b, k);
        ...
        ra.prototype = {
            ...
            buildText: function(a) {
                for (var b = a.element, c = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = z(b, "x"), h = a.styles, i = h && h.width && w(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--;)
                b.removeChild(d[h]);
                ...
                n(c, function(c, d) {
                    ...
                    n(h, function(c) {
                        if (c !== "" || h.length === 1) {
                            ...
                            b.appendChild(o);
                            da++;
                            if (i) for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), t = []; c.length || t.length;)
                            delete a.bBox, F = a.getBBox().width, m = F > i, !m || c.length === 1 ? (c = t, t = [], c.length && (o = C.createElementNS(pa, "tspan"), z(o, {
                                dy: j || 16,
                                x: g
            ...
            button: function(a, b, c, d, e, f, g) {
                var h = this.label(a, b, c),
                    ...
                    e = A(ka("stroke-width", 1, "stroke", "#999", "fill", ka("linearGradient", a, "stops", [
                        [0, "#FFF"],
                        [1, "#DDD"]
                    ]), "r", 3, "padding", 3, "style", ka("color", "black")), e);
                l = e.style;
                delete e.style;
                f = A(e, ka("stroke", "#68A", "fill", ka("linearGradient", a, "stops", [
                    [0, "#FFF"],
                    [1, "#ACF"]
                ])), f);
                m = f.style;
                delete f.style;
                g = A(e, ka("stroke", "#68A", "fill", ka("linearGradient", a, "stops", [
                    [0, "#9BD"],
                    [1, "#CDF"]
                ])), g);
                p = g.style;
            ...
            color: function(a, b, c) {
                ...
                if (g) {
                    ...
                    if (!c.id || !h[c.id]) Ha(c) && (a[g] = c = {
                        ...
                        f.test(a[1]) ? (e = qa(a[1]), j = e.get("rgb"), k = e.get("a")) : (j = a[1], k = 1);
            ...
            label: function(a, b, c, d, e, f, g, h, i) {
                ...
                g.text = function(a, b) {
                    ...
                    if (!o) c = h ? -yb : 0, p.box = o = d ? m.symbol(d, -D * aa, c, p.width, p.height) : m.rect(-D * aa, c, p.width, p.height, 0, fb["stroke-width"]), o.add(p);
                    o.attr(A({
                        width: p.width,
                        height: p.height
                    }, fb));
            ...
            ja = {
                ...
                attr: function(a, b) {
                    ...
                    g = f.style,
                        ...
                        u = this;
                    la(a) && t(b) && (c = a, a = {}, a[c] = b);
                    if (la(a)) c = a, u = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
                    else for (c in a)
                    if (d = a[c], m = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
                        ...
                        if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), m = !0;
                            ...
                            e = d.length;
                            for (m = []; e--;)
                            m[e] = Aa(d[e]) ? s(d[e] * 10) - 5 : d[e] === "Z" ? "x" : d[e];
                            d = m.join(" ") || "x";
                            f.path = d;
                        ...
                        else if (c === "width" || c === "height") d = y(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0;
                        ...
                        (f.getElementsByTagName("stroke")[0] || Q(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0;
                    ...
                    if (i) {
                        ...
                        if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, p = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - J.atan((m - a) / (p - c)) * 180 / xa) + '"', F();
                            ...
                            var j = m.r,
                                ...
                                A = b.radialReference,
                                w, j = function() {
                                    A && (w = d.getBBox(), y += (A[0] - w.x) / w.width - 0.5, x += (A[1] - w.y) / w.height - 0.5, r *= A[2] / w.width, P *= A[2] / w.height);
                ...
                symbols: {
                    ...
                    rect: function(a, b, c, d, e) {
                        var f = a + c,
                            g = b + d,
                            h;
                        !t(e) || !e.r ? f = ra.prototype.symbols.square.apply(0, arguments) : (h = O(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                        return f
                    }
                }
            };
        ...
        Pa.prototype = {
            ...
            render: function(a, b) {
                ...
                if (h && !isNaN(P)) h.xy = r = this.getLabelPosition(P, r, h, f, j, F, a, s), this.isFirst && !o(d.showFirstLabel, 1) || this.isLast && !o(d.showLastLabel, 1) ? v = !1 : !y && f && j.overflow === "justify" && !this.handleOverflow(a, r) && (v = !1), s && a % s && (v = !1), v ? (h[this.isNew ? "attr" : "animate"](r), h.show(), this.isNew = !1) : h.hide()
            },
            destroy: function() {
                Ea(this, this.axis)
            }
        ...
        nb.prototype = {
            render: function() {
                ...
                e(n);
                if (f && t(f.text) && u && u.length && b.width > 0 && b.height > 0) {
                    f = A({
                        align: c && k && "center",
                        x: c ? !k && 4 : 10,
        ...
        ob.prototype = {
            ...
            defaultLabelFormatter: function() {
                ...
                else if (e && g >= 1E3) for (; e-- && f === x;)
                a = Math.pow(1E3, e + 1), g >= a && d[e] !== null && (f = Ia(b / a, -1) + d[e]);
            ...
            getSeriesExtremes: function() {
                ...
                n(a.series, function(g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        var h = g.options,
                            i, j, k, l, m, p, u, n, q, D = h.threshold,
                            s, r = [],
                            v = 0;
                        ...
                        if (a.isXAxis) {
                            ...
                            s = u.length;
                            for (f = 0; f < s; f++)
                            if (n = h[f], q = u[f], i && (w = (F = q < D) ? k : j, P = F ? p : l, q = w[n] = t(w[n]) ? ea(w[n] + q) : q, c[P] || (c[P] = {}), c[P][n] || (c[P][n] = new Hb(a, a.options.stackLabels, F, n, m, i)), c[P][n].setTotal(q)), q !== null && q !== x && (C && (q = g.modifyValue(q)), A || (h[f + 1] || n) >= z.min && (h[f - 1] || n) <= z.max)) if (n = q.length) for (; n--;)
                            q[n] !== null && (r[v++] = q[n]);
                            else r[v++] = q;
            ...
            getLogTickPositions: function(a, b, c, d) {
                ...
                } else if (b = ba(b), c = ba(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = hb(a, null, J.pow(10, T(J.log(a) / J.LN10))), g = Sa(this.getLinearTickPositions(a, b, c), ma), !d) this._minorAutoInterval = a / 5;
            ...
            getMinorTickPositions: function() {
                ...
                } else for (a = this.min + (a[0] - this.min) % b; a <= this.max; a += b)
                c.push(a);
                return c
            },
            ...
            setTickPositions: function(a) {
                var b = this,
                    ...
                    u = b.categories;
                h ? (b.linkedParent = c[g ? "xAxis" : "yAxis"][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && $a(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), b.max = o(b.userMax, d.max, b.dataMax));
            ...
            render: function() {
                var a = this,
                    ...
                    u = a.tickmarkOffset,
                    o = d.lineWidth,
                    q, D = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin),
                    r = a.showAxis,
                    s, v;
                if (a.hasData || f) if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                    ...
                    if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new nb(a)), s = b + u, v = g[c + 1] !== x ? g[c + 1] + u : a.max, l[b].options = {
                        from: e ? ba(s) : s,
                        to: e ? ba(v) : v,
                        color: p
                ...
                if (o) q = a.getLinePath(o), a.axisLine ? a.axisLine.animate({
                    ...
                    "stroke-width": o,
                    zIndex: 7
                }).add(a.axisGroup), a.axisLine[r ? "show" : "hide"]();
        ...
        pb.prototype = {
            ...
            refresh: function(a, b) {
                ...
                if (p) {
                    p = na(p);
                    for (e = p.length; e--;)
                    if (i = a.series[e ? "yAxis" : "xAxis"], p[e] && i) if (i = i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[e]) this.crosshairs[e].attr({
                        d: i,
                        visibility: "visible"
                    });
                    else {
        ...
        qb.prototype = {
            ...
            onmousemove: function(a) {
                ...
                if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                    ...
                    h = c.length;
                    for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length) b = c[i].tooltipPoints[k], b._dist = L(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = O(j, b._dist), e.push(b);
                    for (h = e.length; h--;)
            ...
            setDOMEvents: function() {
                ...
                d.onclick = function(a) {
                    ...
                    a.cancelBubble = !0;
                    if (!c.cancelClick) d && (z(a.target, "isTracker") || z(a.target.parentNode, "isTracker")) ? (e = d.plotX, f = d.plotY, r(d, {
        ...
        rb.prototype = {
            ...
            colorizeItem: function(a, b) {
                ...
                if (f) {
                    if (g) for (j in g = a.convertAttribs(g), g)
                    d = g[j], d !== x && (i[j] = d);
                    f.attr(i)
                }
            },
            ...
            renderItem: function(a) {
                ...
                if (!q && (a.legendGroup = d.g("legend-item").attr({
                    zIndex: 1
                }).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = q = d.text(e.labelFormatter.call(a), l ? g + h : -h, b.baseline, e.useHTML).css(A(a.visible ? i : j)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                ...
                }), b.colorizeItem(a, a.visible), r && s)) a.checkbox = Q("input", {
                    type: "checkbox",
                    checked: a.selected,
        ...
        sb.prototype = {
            ...
            addSeries: function(a, b, c) {
                var d, e = this;
                a && (ua(c, e), b = o(b, !0), E(e, "addSeries", {
                    options: a
                }, function() {
                    d = e.initSeries(a);
                    e.isDirtyLegend = !0;
            ...
            getContainer: function() {
                ...
                this.container = a = Q(ia, {
                    cNameName: "highcharts-container" + (b.className ? " " + b.className : ""),
                    id: e
                }, r({
                    position: "relative",
                    overflow: "hidden",
            ...
            getMargins: function() {
                ...
                this.resetMargins();
                e = this.axisOffset;
                if ((this.title || this.subtitle) && !t(this.optionsMarginTop)) if (l = y(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0)) this.plotTop = y(this.plotTop, l + o(k.margin, 15) + b);
            ...
            firstRender: function() {
                var a = this,
                    b = a.options,
                    c = a.callback;
                if (!Z && K == K.top && C.readyState !== "complete" || U && !K.canvg) U ? Mb.push(function() {
                    a.firstRender()
        ...
        N.prototype = {
            ...
            setData: function(a, b) {
                ...
                if (l > (d.turboThreshold || 1E3)) {
                    ...
                    if (Aa(g)) {
                        ...
                        e[i] = j, k[i] = a[i], j += d;
                        this.xIncrement = j
                    } else if (Ha(g)) if (m) for (i = 0; i < l; i++)
                    d = a[i], e[i] = d[0], k[i] = d.slice(1, m + 1);
                    else for (i = 0; i < l; i++)
            ...
            generatePoints: function() {
                ...
                for (m = 0; m < g; m++)
                i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== x && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
            ...
            translate: function() {
                ...
                for (l = 0; l < h; l++) {
                    ...
                    if (c && this.visible && q && q[p]) r = q[p], p = r.total, r.cum = r = r.cum - n, n = r + n, j && (r = o(b.threshold, f.min)), f.isLog && r <= 0 && (r = null), c === "percent" && (r = p ? r * 100 / p : 0, n = p ? n * 100 / p : 0), k.percentage = p ? k.y * 100 / p : 0, k.total = k.stackTotal = p, k.stackY = n;
            ...
            setTooltipPoints: function(a) {
                ...
                if (this.options.enableMouseTracking !== !1) {
                    ...
                    for (h = 0; h < a; h++) {
                        g = b[h];
                        c = b[h - 1] ? d + 1 : 0;
                        for (d = b[h + 1] ? y(0, T((g[f] + (b[h + 1] ? b[h + 1][f] : e)) / 2)) : e; c >= 0 && c <= d;)
                        i[c++] = g
                    }
            ...
            tooltipHeaderFormatter: function(a) {
                ...
                return b.headerFormat.replace("{point.key}", e && Aa(a) ? cb(c, a) : a).replace("{series.name}", this.name).replace("{series.color}", this.color)
            },
            onMouseOver: function() {
                var a = this.chart,
                    b = a.hoverSeries;
            ...
            drawPoints: function() {
                ...
                if (l.enabled || this._hasPointMarkers) for (f = b.length; f--;)
                if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === x || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e)) if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
        ...
        G = ca(N, {
            ...
            getSegmentPath: function(a) {
                ...
                if (e.stacking && !this.closedStacks) for (d = a.length - 1; d >= 0; d--)
            ...
            drawGraph: function() {
                ...
                c ? c.animate({
                    ...
                    fill: o(b.fillColor, qa(this.color).setOpacity(b.fillOpacity || 0.75).get()),
                    zIndex: 0
                }).add(this.group)
            },
        ...
        ha = ca(N, {
            ...
            translate: function() {
                ...
                var l = a.points,
                    g = L(g.transA) * (g.ordinalSlope || c.pointRange || g.closestPointRange || 1),
                    m = g * c.groupPadding,
                    p = (g - 2 * m) / f,
                    u = c.pointWidth,
                    ...
                    q = o(u, p - 2 * r),
                    s = wa(y(q, 1 + 2 * e)),
                    w = r + (m + ((h ? f - a.columnIndex : a.columnIndex) || 0) * p - g / 2) * (h ? -1 : 1),
            ...
            drawPoints: function() {
                ...
                n(a.points, function(e) {
                    var f = e.plotY,
                        g = e.graphic;
                    if (f !== x && !isNaN(f) && e.y !== null) d = e.shapeArgs, g ? (eb(g), g.animate(A(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
        ...
        ya = {
            ...
            drawDataLabels: function() {
                ...
                if (d.enabled || this._hasPointLabels) {
                    ...
                    for (a = r[0][0] && r[0][0].dataLabel && (r[0][0].dataLabel.getBBox().height || 21); y--;) {
                        var x = [],
                            A = [],
                            z = r[y],
                            C = z.length,
                        ...
                        if (j > 0) {
                            ...
                            for (v = 0; v < C; v++) {
                                ...
                                b = 9999;
                                for (q = 0; q < t; q++)
                                g = L(x[q] - h[1]), g < b && (b = g, B = q);
                                if (B < v && x[v] !== null) B = v;
                                else for (t < C - v + B && x[v] !== null && (B = t - C + v); x[B] === null;)
                                B++;
                                A.push({
                                    i: B,
                                    y: x[B]
